    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <header className="fixed top-12 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <span className="text-xl font-bold text-indigo-600">ModernCo</span>
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <span className="hover:text-indigo-600 cursor-pointer transition-colors">Pricing</span>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-2xl border border-slate-200 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-100 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-12 rounded-3xl border border-slate-200">
              <span className="text-indigo-600 font-medium">Benefit One</span>
            ...
            <div className="bg-indigo-600 text-white p-12 rounded-3xl">
              <span className="text-indigo-200 font-medium">Benefit Two</span>
              <h3 className="text-2xl md:text-3xl font-bold mt-2 mb-4">Duis Aute Irure Dolor</h3>
              <p className="text-indigo-100 mb-8">
                In reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint.
              </p>
              <div className="bg-indigo-500 rounded-xl aspect-video" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className={`p-8 rounded-2xl border ${plan.popular ? "border-indigo-600 ring-2 ring-indigo-600" : "border-slate-200"}`}>
                {plan.popular && (
                ...
                <Button className={`w-full ${plan.popular ? "bg-indigo-600 hover:bg-indigo-700" : ""}`} variant={plan.popular ? "default" : "outline"}>
                  Get Started
                </Button>
              </div>
            ))}
      ...
      {/* CTA */}
      <section className="py-24 md:py-32 bg-indigo-600 text-white">
      ...
      <footer className="bg-slate-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              <span className="text-xl font-bold text-indigo-400">ModernCo</span>
